    ...
    <div className="mt-20 flex flex-col items-center">
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-8 w-full max-w-5xl">
        ...
        <div className="max-w-lg text-center md:text-left">
          ...
          <h1 className="text-4xl mt-4 md:text-5xl text-white">Jayanithya Madhushani.</h1>
          ...
          <p className="mt-4 text-white/80 leading-relaxed">
            ...
            problem-solving, creativity, and continuous learning, I strive to push
      ...
      <div className="w-full flex justify-start gap-8 mt-6">
        {[
          ...
          { title: "Volunteering & Leadership", component: <VolunteeringSection /> },
        ].map(({ title }) => (
          <button
            key={title}
          ...
          >
            ...
            <div
              className={`absolute left-0 bottom-0 w-0 h-0.5 bg-gradient-to-r from-emerald-300 to-sky-400 transition-all duration-500 ease-in-out ${
                visibleSection === title ? "w-full opacity-100" : "group-hover:w-full group-hover:opacity-100"
              }`}
            ></div>
          </button>
        ))}
